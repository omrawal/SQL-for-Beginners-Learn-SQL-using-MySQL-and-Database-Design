...
insert into products (product_name,price,coffee_origin)
values ('espresso',2.50,"brazil");

insert into products (product_name,price,coffee_origin)
values ('Macchito',3.00,"Brazil"),("Cappuccino",3.50,"Costa Rica");


insert into products (product_name,price,coffee_origin)
values ('Latter',3.50,"Indonesia"),
("Americano",3.00,"Brazil"),
("Flat White",3.50,"Indonesia"),
("Filter",3.00,"India");

update products 
set product_name="Espresso",price=2.50,coffee_origin="Brazil"
where id= 1;
